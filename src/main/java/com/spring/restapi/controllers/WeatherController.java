...
import com.spring.restapi.models.WeatherResponse;
import com.spring.restapi.models.WeatherUrl;
	...
	public class WeatherController {
		...
		public String getWeather(Model model, @ModelAttribute FormCityAttribute city) 
			...
			String url = String.format("%s/%s/%s,%s", weatherData.getDarkurl(), weatherData.getDarkapiKey(), weather.getLat(), weather.getLon());
			
			WeatherResponse weatherResponse=restTemp.getForObject(url, WeatherResponse.class);
			
			weather.setWeatherDescription(weatherResponse.getSummary());
